...
func TestQueue(t *testing.T) {
	...
	job1.WithMetadata(jobEntities.JOB_TYPE_OSINT, jobEntities.JOB_PRIORITY_LOW, 10, nil)
	...
	job2.WithMetadata(jobEntities.JOB_TYPE_OSINT, jobEntities.JOB_PRIORITY_MEDIUM, 10, nil)
	...
	job3.WithMetadata(jobEntities.JOB_TYPE_OSINT, jobEntities.JOB_PRIORITY_HIGH, 10, nil)
	...
	job4.WithMetadata(jobEntities.JOB_TYPE_OSINT, jobEntities.JOB_PRIORITY_MEDIUM, 30, nil)
	...
	job5.WithMetadata(jobEntities.JOB_TYPE_OSINT, jobEntities.JOB_PRIORITY_CRITICAL, 20, nil)
